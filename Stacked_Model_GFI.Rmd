...
Based on models above, we believe we are on track to achieving our objectives. All of the models are reasonably accurate and provide valuable insight with varying levels of interpretability. Our SVM model is our most accurate however it may be overfitting. We artificially reduced the sigma to prevent it from overfitting, but this of course reduces the accuracy of the entire stacked model
