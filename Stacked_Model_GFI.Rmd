...
model_ann2 <- neuralnet(fourth_down_converted ~ ., data = GFI_mm, stepmax = 100000000, hidden = c(3, 3))
model_ann3 <- neuralnet(fourth_down_converted ~ ., data = GFI_mm, stepmax = 100000000, hidden = c(2, 2, 2))
model_ann4 <- neuralnet(fourth_down_converted ~ ., data = GFI_mm, stepmax = 100000000, hidden = c(5))
model_ann5 <- neuralnet(fourth_down_converted ~ ., data = GFI_mm, stepmax = 100000000, hidden = c(4, 3))
model_ann6 <- neuralnet(fourth_down_converted ~ ., data = GFI_mm, stepmax = 100000000, hidden = c(1, 2, 3))
model_ann7 <- neuralnet(fourth_down_converted ~ ., data = GFI_mm, stepmax = 100000000, hidden = c(5, 5, 5))
```
