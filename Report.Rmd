...
We found that there is a cutoff for the yards to get to the opponent’s end zone. If there are 64 or less yards, our model predicts to go for it. If there are more than 64 yards to get to the end zone, then our model predicts to not go for it. 
...
TODO Mark Comment on specific scenarios
